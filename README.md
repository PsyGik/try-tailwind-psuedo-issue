# Issue Reproduction Repo
- Clone the repo
- Run `npm install`
- Navigate to `localhost:3000`
- Observe `:before` is applied to every single element
- Uncomment `@tailwind components;` in `css/tailwind.css`
- Observe `:before` is not applied to every single element.
- Root cause: Unknown
